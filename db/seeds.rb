Movie.create([
  ...
  { 
    :title => "Snatch"
    :description => "While transporting a pinched 84-karat sparkler to his stateside boss, a gangster stops off in London and inadvertently triggers a slew of fateful events that wends through the worlds of bookies, pawnshops, bare-knuckle boxing and swine." 
    :link => "http://movies.netflix.com/WiMovie/Snatch/60003388?trkid=4422485"
    :image_url => "http://cdn-8.nflximg.com/images/1330/1061330.jpg"
  }, 
  { 
    :title => "True Grit"
  ...
  {
    :title => "Top Gun"
    :description => "Tom Cruise stars as a hotshot flyboy who struggles to control himself, responsibility and a steamy love affair while competing at the U.S. Navy's fighter-weapons school, better known as Top Gun. Anthony Edwards plays his loyal co-pilot."
    :link => "http://movies.netflix.com/WiMovie/Top_Gun/1056189?trkid=4415535"
    :image_url => "http://cdn-9.nflximg.com/images/4361/1084361.jpg"
  }, 
  { 
    :title => "Thor"
  ...
  { 
    ...
    :link => "http://movies.netflix.com/WiMovie/Judy_Moody_and_the_Not_Bummer_Summer/70183165?trkid=4460452" 
    :image_url => "http://cdn-5.nflximg.com/images/1907/1091907.jpg"
  },
  {
    :title => "Daddy Day Care"
    :description => "When a conscientious father loses his lucrative dot-com job and faces economic ruin, he joins two friends in opening a business called Daddy Day Care. But as the venture takes off, it attracts the attention of a rival who doesn't like competition."
    :link => "http://movies.netflix.com/WiMovie/Daddy_Day_Care/60027689?trkid=4460452"
    :image_url => "http://cdn-9.nflximg.com/images/4496/1304496.jpg"
  }, 
  {
    :title => "Wallace & Gromit in Three Amazing Adventures"
    :description => "Animator Nick Park's most beloved creations -- the unflappable, cheese-worshipping Wallace and his loyal dog, Gromit -- come to life in this collection of three adventures." 
    :link => "http://movies.netflix.com/WiMovie/Wallace_Gromit_in_Three_Amazing_Adventures/70212572?trkid=4460452"
    :image_url => "http://cdn-2.nflximg.com/images/3409/1273409.jpg"
  },
  {
    :title => "Labyrinth"
    :description => "In this Jim Henson-directed fantasy, teenage Sarah (Jennifer Connelly) embarks on a life-altering quest when she attempts to rescue her little brother, Toby (Toby Froud), from the clutches of treacherous Jareth the Goblin King (David Bowie), who lives in a castle surrounded by a giant labyrinth. With just 13 hours to plot a course through the dangerous maze, Sarah must grow up fast, learn her responsibilities and muster supreme courage."
    :link => "http://movies.netflix.com/WiMovie/Labyrinth/680020?trkid=4460452"
    :image_url => "http://cdn-0.nflximg.com/images/6360/1046360.jpg"
  },
  {
  ...
  # Classics 
  {
    ...
    :description => "http://movies.netflix.com/WiMovie/Arsenic_and_Old_Lace/60001333?trkid=4426259"
    :link => "http://movies.netflix.com/WiMovie/Arsenic_and_Old_Lace/60001333?trkid=4426259"
    :image_url => "http://cdn-3.nflximg.com/images/4334/1044334.jpg"
  }, 
  { 
    ...
    :link => "http://movies.netflix.com/WiMovie/Where_the_Sidewalk_Ends/70010825?trkid=4478650"
    :image_url => "http://cdn-5.nflximg.com/images/6762/1046762.jpg"
  }, 
  {
    :title => "Cleopatra"
    :description => "http://movies.netflix.com/WiMovie/Cleopatra/60011693?trkid=4430381" 
    :link => "http://movies.netflix.com/WiMovie/Cleopatra/60011693?trkid=4430381"
    :image_url => "http://cdn-3.nflximg.com/images/4758/1044758.jpg"
  }, 
  {
    ...
    :link => "http://movies.netflix.com/WiMovie/Doctor_Zhivago/449931?trkid=4430381"
    :image_url => "http://cdn-1.nflximg.com/images/0814/1060814.jpg"
  }, 
  { 
  ...
  { 
    ...
    :link => "http://movies.netflix.com/WiMovie/Office_Space/20358351?trkid=4448434"
    :image_url => "http://cdn-1.nflximg.com/images/0517/1060517.jpg"
  }, 
  {
    :title => "Clerks"
    :description => "Store clerks Dante and Randal are sharp-witted, potty-mouthed, and bored out of their minds. So in between needling customers, the counter jockeys play hockey, visit a funeral home and deal with their love lives in this classic indie comedy."
    :link => "http://movies.netflix.com/WiMovie/Clerks/382722?trkid=4448434"
    :image_url => "http://cdn-2.nflximg.com/images/4107/1044107.jpg"
  }, 
  {
    :title => "Art School Confidential"
    :description => "When his pure genius goes ignored and a brainless jock tempts his dream girl (Sophia Myles), ambitious art school student Jerome Platz (Max Minghella) sets in motion a brazen plan to become an art world hero and win his beloved's heart. John Malkovich, Jim Broadbent, Matt Keeslar, Anjelica Huston and Ethan Suplee co-star in Terry Zwigoff's dark comedy about an overachiever who goes to extremes to get the girl."
    :link => "http://movies.netflix.com/WiMovie/Art_School_Confidential/70043943?trkid=4471145"
    :image_url => "http://cdn-3.nflximg.com/images/8467/1048467.jpg"
  },
  {
    :title => "Wet Hot American Summer"
    :description => "It's the last day of summer for Camp Firewood's staff and patrons, and everyone wants a final shot at some action. For Beth (Janeane Garofalo), that means getting it on with nerdy astrophysicist Henry (David Hyde Pierce). Ditto for the lovelorn Coop (Michael Showalter), who'd like nothing better than to lip-lock with fellow counselor Katie (Marguerite Moreau). Paul Rudd, Molly Shannon and Elizabeth Banks co-star in this spoof on summer-camp camp."
    :link => "http://movies.netflix.com/WiMovie/Wet_Hot_American_Summer/60021299?trkid=4455303"
    :image_url => "http://cdn-9.nflximg.com/images/4928/1044928.jpg"
  },
  {
    :title => "The Big Lebowski"
    :description => "Slacker Jeff \"The Dude\" Lebowski (Jeff Bridges) gets involved in a gargantuan mess of events when he's mistaken for another man named Lebowski, whose wife has been kidnapped and is being held for ransom. All the while, Dude's friend, Walter (John Goodman), stirs the pot. Brothers Joel Coen and Ethan Coen write and direct this cult comedy classic that also stars Steve Buscemi, Philip Seymour Hoffman, Julianne Moore and John Turturro."
  ...
  # Drama
  {
    ...
    :link => "http://movies.netflix.com/WiMovie/The_Red_Violin/5670353?trkid=4415674"
    :image_url => "http://cdn-3.nflximg.com/images/4186/1044186.jpg"
  }, 
  {
    :title => "The Last of the Mohicans"
    :description => "When rugged frontiersman Hawkeye (Daniel Day-Lewis) saves the Munro sisters -- two newly arrived English settlers -- from a Huron ambush, he ends up in the midst of the battle between the British and the French for control of the American colonies. Director Michael Mann's first-rate production also stars Madeleine Stowe as the Munro sister who wins Hawkeye's heart, and Wes Studi as the Huron warrior who has a score to settle with her father."
    :link => "http://movies.netflix.com/WiMovie/The_Last_of_the_Mohicans/686619?trkid=4417397"
    :image_url => "http://cdn-9.nflximg.com/images/6371/1046371.jpg"
  },
  {
    :title => "Buffalo '66"
    :description => "Writer-director Vincent Gallo stars as Billy Brown, who -- fresh from a five-year stint in jail -- heads home to Buffalo, N.Y., to visit his kin. Eager to impress his insouciant parents, Billy kidnaps buxom Layla and makes her pose as his wife."
    :link => "http://movies.netflix.com/WiMovie/Buffalo_66/8177867?trkid=4554065"
    :image_url => "http://cdn-7.nflximg.com/images/3633/1093633.jpg"
  },
  {
    :title => "Good Will Hunting"
    :description => "When professors discover that an aimless janitor is also a math genius, a therapist helps the young man confront the demons that are holding him back in this uplifting drama about friendship and risk."
    :link => "http://movies.netflix.com/WiMovie/Good_Will_Hunting/17405997?trkid=4530178"
    :image_url => "http://cdn-7.nflximg.com/images/0442/1060442.jpg"
  },
  {
    :title => "The Departed"
    :description => "To take down South Boston's Irish Mafia, the police send in one of their own to infiltrate the underworld, not realizing the syndicate has done likewise in Martin Scorsese's multiple Oscar-winning crime thriller. While an undercover cop (Leonardo DiCaprio) curries favor with the mob kingpin (Jack Nicholson), a career criminal (Matt Damon) rises through the police ranks. But both sides soon discover there's a mole among them."
